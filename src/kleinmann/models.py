...
from kleinmann.fields.data import IntField
...
from kleinmann.filters import FilterInfoDict, get_filters_for_field
from kleinmann.functions import Function
from kleinmann.indexes import Index
from kleinmann.manager import Manager
from kleinmann.queryset import (
    BulkCreateQuery,
    BulkUpdateQuery,
    ExistsQuery,
    Q,
...
class ModelMeta(type):
    ...
    def __new__(mcs, name: str, bases: Tuple[Type, ...], attrs: dict):
        ...
        for fname, comment in _get_comments(new_class).items():  # type: ignore[arg-type]
...
class Model(metaclass=ModelMeta):
    """
    Base class for all Kleinmann ORM Models.
    """
    ...
    def register_listener(cls, signal: Signals, listener: Callable):
        ...
        :param signal: one of kleinmann.signals.Signals
    ...
    def describe(cls, serializable: bool = True) -> dict:
        ...
        :return:
            ...
            Each field is specified as defined in :meth:`kleinmann.fields.base.Field.describe`
        """
        return {
