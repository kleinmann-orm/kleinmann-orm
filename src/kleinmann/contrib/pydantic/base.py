...
def _get_fetch_fields(
    ...
    :param model_class: The kleinmann model class
...
class PydanticModel(BaseModel):
    """
    Pydantic BaseModel for Kleinmann objects.
    ...
    def _kleinmann_convert(cls, value):  # pylint: disable=E0213
        # Computed fields
        if callable(value):
            return value()
    ...
    @classmethod
    async def from_kleinmann_orm(cls, obj: "Model") -> Self:
        """
        ...
        .. note::
            ...
            :class:`kleinmann.contrib.pydantic.creator.PydanticMeta`, or you would be
...
class PydanticListModel(RootModel):
    """
    Pydantic BaseModel for List of Kleinmann Models
