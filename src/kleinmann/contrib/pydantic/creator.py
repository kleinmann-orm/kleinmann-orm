...
def pydantic_model_creator(
    ...
    *,
    ...
    """
    Function to build `Pydantic Model <https://pydantic-docs.helpmanual.io/usage/models/>`__ off Kleinmann Model.

    :param _stack: Internal parameter to track recursion
    :param cls: The Kleinmann Model
...
def pydantic_queryset_creator(
    ...
    *,
    ...
    """
    Function to build a `Pydantic Model <https://pydantic-docs.helpmanual.io/usage/models/>`__ list off Kleinmann Model.

    :param cls: The Kleinmann Model to put in a list.
    :param name: Specify a custom name explicitly, instead of a generated name.
