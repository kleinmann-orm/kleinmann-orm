...
class Field(Generic[VALUE], metaclass=_FieldMeta):
    ...
    :param description: Field description. Will also appear in ``Kleinmann.describe_model()``
    ...
    **Per-DB overrides:**
    ...
    Kleinmann will then use the overridden attributes/functions for that dialect.
