...
from kleinmann.filters import get_m2m_filters
...
class Kleinmann:
    ...
    def get_connection(cls, connection_name: str) -> BaseDBAsyncClient:
        ...
        .. warning::
           ...
           :meth:`connections.get<kleinmann.connection.ConnectionHandler.get>` instead.
        """
    ...
    def describe_model(
        ...
        See :meth:`kleinmann.models.Model.describe`

        .. warning::
           This is deprecated, please use :meth:`kleinmann.models.Model.describe` instead
        """
        warnings.warn(
            "Kleinmann.describe_model(<MODEL>) is deprecated, please use <MODEL>.describe() instead",
            DeprecationWarning,
            stacklevel=2,
        )
    ...
    def init_models(
        ...
        """
        Early initialisation of Kleinmann ORM Models.
    ...
    async def close_connections(cls) -> None:
        ...
        .. warning::
           This is deprecated and will be removed in a future release. Please use
           :meth:`connections.close_all<kleinmann.connection.ConnectionHandler.close_all>` instead.
        """
...
__version__ = importlib_metadata.version("kleinmann-orm")
